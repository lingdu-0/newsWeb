	...
	<form id="form1" name="form1" action="cate">
		<table width="90%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td><input name="cid" type="text" class="input1" value="${cate.cid}"/>
				<input name="flag" value="1" type="hidden" /></td>
			</tr>
			<tr>
				<th width="15%" align="right">类别名称</th>
				<td><input name="cname" type="text" class="input1" value="${cate.cname}"/></td>
			</tr>
		</table>
		<table width="90%" border="0" align="center" cellpadding="0"
